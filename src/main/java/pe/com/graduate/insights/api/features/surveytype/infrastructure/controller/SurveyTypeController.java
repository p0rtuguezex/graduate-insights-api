package pe.com.graduate.insights.api.features.surveytype.infrastructure.controller;
...
@Tag(name = "Tipos de Encuesta", description = "APIs para gestion de tipos de encuesta")
public class SurveyTypeController {
  ...
  @Operation(
      ...
      description = "Obtiene un tipo de encuesta especifico por su ID")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<
          pe.com.graduate.insights.api.shared.models.response.ApiResponse<SurveyTypeResponse>>
      getSurveyType(
  ...
  @Operation(
      ...
      description = "Crea un nuevo tipo de encuesta con la informacion proporcionada")
  @ApiResponses(
      value = {
  ...
  @Operation(
      ...
      description = "Actualiza un tipo de encuesta existente con la informacion proporcionada")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "204",
  ...
  @Operation(
      ...
      description = "Obtiene una lista paginada de tipos de encuesta con busqueda opcional")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @GetMapping
  ResponseEntity<
          pe.com.graduate.insights.api.shared.models.response.ApiResponse<List<SurveyTypeResponse>>>
      getListSurveyTypesPaginate(
          @Parameter(description = "Termino de busqueda", example = "satisfaccion")
  ...
  @Operation(
      ...
      description = "Obtiene una lista completa de tipos de encuesta sin paginacion")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @GetMapping("/list")
  public ResponseEntity<
          pe.com.graduate.insights.api.shared.models.response.ApiResponse<List<KeyValueResponse>>>
  ...
  @Operation(
      ...
      description = "Obtiene todos los tipos de encuesta que estan activos")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
