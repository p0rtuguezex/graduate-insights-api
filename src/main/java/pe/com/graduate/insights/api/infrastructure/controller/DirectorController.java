...
public class DirectorController {
  ...
  @GetMapping("/{id}")
  public ResponseEntity<ApiResponse<DirectorResponse>> getDirector(@PathVariable Long id) {
    return ResponseUtils.successResponse(directorUseCase.getDomain(id));
  }

  @PostMapping
  public ResponseEntity<ApiResponse<Void>> saveDirector(
  ...
  @PutMapping("/{id}")
  public ResponseEntity<ApiResponse<Void>> updateDirector(
  ...
  @GetMapping
  ResponseEntity<ApiResponse<List<DirectorResponse>>> getListDirectoresPaginate(
