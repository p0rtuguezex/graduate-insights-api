package pe.com.graduate.insights.api.features.eventtypes.infrastructure.controller;
...
public class EventTypesController {
  ...
  public ResponseEntity<
          pe.com.graduate.insights.api.shared.models.response.ApiResponse<EventTypesResponse>>
      getEducationCenter(
  ...
  @GetMapping
  ResponseEntity<
          pe.com.graduate.insights.api.shared.models.response.ApiResponse<List<EventTypesResponse>>>
  ...
  @GetMapping("/list")
  public ResponseEntity<List<KeyValueResponse>> getListEducationCenterAll() {
