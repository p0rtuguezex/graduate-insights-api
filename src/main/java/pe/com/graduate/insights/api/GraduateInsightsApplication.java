...
public class GraduateInsightsApplication {
  ...
  @Bean
  public ApplicationRunner corsConfigLogger(
    ...
    return args -> {
      ...
      if (envCorsOrigins != null) {
        System.out.println(
            "✅ Variable de entorno CORS_ALLOWED_ORIGINS detectada: " + envCorsOrigins);
      } else {
        System.out.println(
            "⚠️ Variable de entorno CORS_ALLOWED_ORIGINS no encontrada, usando valor por defecto");
      }
      System.out.println("========================================");
    };
  }
