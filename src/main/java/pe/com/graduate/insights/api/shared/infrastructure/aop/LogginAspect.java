package pe.com.graduate.insights.api.shared.infrastructure.aop;
...
public class LogginAspect {
  ...
  @Pointcut(
      "execution(* pe.com.graduate.insights.api.shared.infrastructure.repository.adapter..*(..))"
          + " || execution(* pe.com.graduate.insights.api.features..infrastructure.adapter..*(..))")
