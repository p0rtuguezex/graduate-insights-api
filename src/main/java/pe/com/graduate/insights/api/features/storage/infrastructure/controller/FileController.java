package pe.com.graduate.insights.api.features.storage.infrastructure.controller;
...
public class FileController {
  ...
  @Operation(
      ...
      description =
          "Sube un archivo y devuelve el path del archivo guardado. Soporta PDF, DOC, DOCX, JPG, JPEG y PNG.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
        ...
        @ApiResponse(
            responseCode = "400",
            description = "Archivo inválido o excede el tamaño máximo (10MB)"),
        @ApiResponse(responseCode = "401", description = "No autorizado"),
        @ApiResponse(responseCode = "403", description = "Acceso denegado")
      })
  @PreAuthorize("hasRole('DIRECTOR')")
  @PostMapping("/upload")
  public ResponseEntity<pe.com.graduate.insights.api.shared.models.response.ApiResponse<String>>
      uploadFile(
  ...
  public ResponseEntity<Resource> downloadFile(
      @Parameter(description = "Nombre del archivo", required = true) @PathVariable
          String fileName) {
