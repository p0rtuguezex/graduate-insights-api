...
public class SurveyTypeRepositoryAdapter implements SurveyTypeRepositoryPort {
    ...
    public SurveyTypeResponse getDomain(Long id) {
        SurveyTypeEntity entity = surveyTypeRepository.findById(id)
                .orElseThrow(() -> new NotFoundException("Tipo de encuesta no encontrado con ID: " + id));
    ...
    public List<SurveyTypeResponse> getActiveTypes() {
        return surveyTypeRepository.findByActiveTrue()
                .stream()
