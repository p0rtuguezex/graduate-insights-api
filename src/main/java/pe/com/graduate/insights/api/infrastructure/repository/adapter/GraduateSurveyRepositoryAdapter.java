...
public class GraduateSurveyRepositoryAdapter implements GraduateSurveyRepositoryPort {
    ...
    public List<GraduateSurveyListResponse> getAllSurveysForGraduate(Long graduateId) {
        ...
        Set<Long> completedSurveyIds = completedSurveys.stream()
        ...
        return allSurveys.stream()
                .map(survey -> {
                    ...
                    var completedResponse = completedSurveys.stream()
    ...
    public GraduateSurveyDetailResponse getSurveyDetailForGraduate(Long surveyId, Long graduateId) {
        ...
        var graduateResponse = graduateSurveyResponseRepository.findBySurveyIdAndGraduateId(surveyId, graduateId);

        // Mapear las preguntas con sus respuestas
        List<QuestionDetailResponse> questionDetails = survey.getQuestions().stream()
                .map(question -> {
                    ...
                    if (graduateResponse.isPresent()) {
                        var questionResponse = graduateResponse.get().getResponses().stream()
                        ...
                        if (questionResponse.isPresent()) {
                            ...
                            builder.answered(true)
                                    ...
                                    .selectedOptionIds(resp.getSelectedOptions() != null ?
